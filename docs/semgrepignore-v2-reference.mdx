...
## The target filtering process[​](#the-target-filtering-process "Direct link to The target filtering process")
...
## Sources of Semgrepignore patterns[​](#sources-of-semgrepignore-patterns "Direct link to Sources of Semgrepignore patterns")
...
2. default Semgrepignore patterns, `.gitignore` files, `.semgrepignore` files.
...
## Legacy Semgrepignore v1[​](#legacy-semgrepignore-v1 "Direct link to Legacy Semgrepignore v1")
...
[Edit this page](https://github.com/semgrep/semgrep-docs/edit/main/docs/semgrepignore-v2-reference.md)
