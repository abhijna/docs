...
## Ensure your scans use open source components[​](#ensure-your-scans-use-open-source-components "Direct link to Ensure your scans use open source components")
...
<Accordion title="Click to expand for an example of a rule with a  key.">
  `license`
...
## Set up the CI job[​](#set-up-the-ci-job "Direct link to Set up the CI job")

### Use template configuration files[​](#use-template-configuration-files "Direct link to Use template configuration files")
...
### Use other methods[​](#use-other-methods "Direct link to Use other methods")

Use either of the following methods to run Semgrep on other CI providers.

#### Direct docker usage[​](#direct-docker-usage "Direct link to Direct docker usage")
...
#### Install `semgrep` within your CI job[​](#install-semgrep-within-your-ci-job "Direct link to install-semgrep-within-your-ci-job")
...
## Configure your CI job[​](#configure-your-ci-job "Direct link to Configure your CI job")

The following sections describe methods to customize your CI job.

### Schedule your scans[​](#schedule-your-scans "Direct link to Schedule your scans")
...
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| GitHub Actions      | See [Sample CI configs](/docs/semgrep-ci/sample-ci-configs#sample-github-actions-configuration-file) for information on how to modify your `semgrep.yml` file |
...
### Customize rules and rulesets[​](#customize-rules-and-rulesets "Direct link to Customize rules and rulesets")

#### Add rules to scan with `semgrep scan`[​](#add-rules-to-scan-with-semgrep-scan "Direct link to add-rules-to-scan-with-semgrep-scan")
...
#### Write your own rules[​](#write-your-own-rules "Direct link to Write your own rules")
...
### Save or export findings to a file[​](#save-or-export-findings-to-a-file "Direct link to Save or export findings to a file")
...
## Migrate to Semgrep AppSec Platform from a stand-alone CI setup[​](#migrate-to-semgrep-appsec-platform-from-a-stand-alone-ci-setup "Direct link to Migrate to Semgrep AppSec Platform from a stand-alone CI setup")
...
## Semgrep CE jobs versus Semgrep jobs[​](#semgrep-ce-jobs-versus-semgrep-jobs "Direct link to Semgrep CE jobs versus Semgrep jobs")

| Feature                                                                              | Semgrep CI (`semgrep ci`) | Semgrep CE CI (`semgrep scan`) |
| ------------------------------------------------------------------------------------ | ------------------------- | ------------------------------ |
| Customized SAST scans                                                                | ✔️                        | ✔️                             |
| [SCA (software composition analysis) scans](/docs/semgrep-supply-chain/overview)     | ✔️                        | --                             |
| [Secrets scans](/docs/semgrep-secrets/conceptual-overview)                           | ✔️                        | --                             |
| [PR (pull request) or MR (merge request) comments](/docs/category/pr-or-mr-comments) | ✔️                        | --                             |
| [Finding status tracked over lifetime](/docs/semgrep-code/findings)                  | ✔️                        | --                             |
...
[Edit this page](https://github.com/semgrep/semgrep-docs/edit/main/docs/deployment/oss-deployment.md)
