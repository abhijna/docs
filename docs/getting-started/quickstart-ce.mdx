...
## Install Semgrep CE[​](#install-semgrep-ce "Direct link to Install Semgrep CE")
...
## Create a test file for use with Semgrep CE[​](#create-a-test-file-for-use-with-semgrep-ce "Direct link to Create a test file for use with Semgrep CE")
...
## Scan `app.py` with Semgrep CE[​](#scan-apppy-with-semgrep-ce "Direct link to scan-apppy-with-semgrep-ce")
...
## View and understand Semgrep Scan output[​](#view-and-understand-semgrep-scan-output "Direct link to View and understand Semgrep Scan output")
...
[Edit this page](https://github.com/semgrep/semgrep-docs/edit/main/docs/getting-started/quickstart-ce.md)
