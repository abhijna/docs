...
| Production backlog                                                        | Displays data about all the findings detected in your primary or default branch and helps you answer the following questions:- How is my security posture doing over time?
- Is my backlog decreasing or increasing?
- Is the team addressing findings faster than new findings are coming in?                                                  |
| [Secure guardrails](/docs/secure-guardrails/secure-guardrails-in-semgrep) | Displays data relevant to the deployment and adoption of secure guardrails. It helps address the following:- How many vulnerabilities did Semgrep prevent from entering production over time?
...
| Most findings by project                                                  | Lists projects arranged by most open findings to least, grouped by **product** or **severity**. Helps answer the following:- Which of my projects have the most findings in a particular product area?
...
## Export reports[​](#export-reports "Direct link to Export reports")

To generate reports from the current view, click **Dashboard > Download**.

## Triage states[​](#triage-states "Direct link to Triage states")
...
## Filters and configuration[​](#filters-and-configuration "Direct link to Filters and configuration")
...
### Recommended priority[​](#recommended-priority "Direct link to Recommended priority")
...
## Production backlog[​](#production-backlog "Direct link to Production backlog")
...
| Backlog activity | Displays the number of new, net new, fixed, and ignored, including provisionally ignored, findings. A greater **Fixed** value is better. Clicking on this chart opens a drawer that provides a breakdown of findings by triage state for that selected time period. |

## Secure guardrails[​](#secure-guardrails "Direct link to Secure guardrails")
...
### Key metrics[​](#key-metrics-1 "Direct link to Key metrics")
...
### Charts[​](#charts-1 "Direct link to Charts")
...
## Most findings by project[​](#most-findings-by-project "Direct link to Most findings by project")
...
## Median open age[​](#median-open-age "Direct link to Median open age")
...
[Edit this page](https://github.com/semgrep/semgrep-docs/edit/main/docs/semgrep-appsec-platform/dashboard.md)
