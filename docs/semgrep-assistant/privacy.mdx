---
title: "Privacy and legal considerations for Semgrep Assistant"
---
...
## Zero Data Retention from model vendors[​](#zero-data-retention-from-model-vendors "Direct link to Zero Data Retention from model vendors")
...
* Semgrep stores and retains AI responses based on these code snippets for up to 6 months. Semgrep, Inc. will provide at least 30 days' notice if Semgrep make any changes to the retention policy.
...
## Semgrep Assistant minimal data retention policy (optional)[​](#semgrep-assistant-minimal-data-retention-policy-optional "Direct link to Semgrep Assistant minimal data retention policy (optional)")
...
For more details, see [Data Privacy Overview - Semgrep Assistant](https://drive.google.com/file/d/19a9m67TS4lRaRusMmsNlIjttTY5b1lEf/view)
...
[Edit this page](https://github.com/semgrep/semgrep-docs/edit/main/docs/semgrep-assistant/privacy.md)
