...
## Voice and tone[​](#voice-and-tone "Direct link to Voice and tone")
...
### Write memories that are general in nature[​](#write-memories-that-are-general-in-nature "Direct link to Write memories that are general in nature")
...
### State all implications and be clear on what the consequences of something are[​](#state-all-implications-and-be-clear-on-what-the-consequences-of-something-are "Direct link to State all implications and be clear on what the consequences of something are")
...
### Understand the context available to Assistant[​](#understand-the-context-available-to-assistant "Direct link to Understand the context available to Assistant")
...
[Edit this page](https://github.com/semgrep/semgrep-docs/edit/main/docs/semgrep-assistant/best-practices-for-memories.md)
