...
## Official IDE extensions[​](#official-ide-extensions "Direct link to Official IDE extensions")

| Name                                                   | Marketplace link                                                                        | Documentation                                                   |
| ------------------------------------------------------ | --------------------------------------------------------------------------------------- | --------------------------------------------------------------- |
| Microsoft Visual Studio Code                           | [`semgrep-vscode`](https://marketplace.visualstudio.com/items?itemName=semgrep.semgrep) | [Semgrep VS Code extension](/docs/extensions/semgrep-vs-code)   |
| IntelliJ Ultimate Ideaand many other IntelliJ products | [`semgrep-intellij`](https://plugins.jetbrains.com/plugin/22622-semgrep)                | [Semgrep IntelliJ extension](/docs/extensions/semgrep-intellij) |
| Emacs                                                  | [`lsp-mode`](https://github.com/emacs-lsp/lsp-mode)                                     | See repository README                                           |

## Use of Language Server Protocol (LSP)[​](#use-of-language-server-protocol-lsp "Direct link to Use of Language Server Protocol (LSP)")
...
## `pre-commit`[​](#pre-commit "Direct link to pre-commit")
...
## Semgrep as an engine[​](#semgrep-as-an-engine "Direct link to Semgrep as an engine")
...
[Edit this page](https://github.com/semgrep/semgrep-docs/edit/main/docs/extensions/overview.md)
