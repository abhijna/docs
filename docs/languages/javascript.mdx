...
## JavaScript support in Semgrep Code[​](#javascript-support-in-semgrep-code "Direct link to JavaScript support in Semgrep Code")
...
#### Benchmark results exclusive of [AI](/docs/semgrep-assistant/overview) processing[​](#benchmark-results-exclusive-of-ai-processing "Direct link to benchmark-results-exclusive-of-ai-processing")
...
## JavaScript support in Semgrep Supply Chain[​](#javascript-support-in-semgrep-supply-chain "Direct link to JavaScript support in Semgrep Supply Chain")
...
## JavaScript support in Semgrep CE[​](#javascript-support-in-semgrep-ce "Direct link to JavaScript support in Semgrep CE")
...
[Edit this page](https://github.com/semgrep/semgrep-docs/edit/main/docs/languages/javascript.md)
