...
## Java support in Semgrep Supply Chain[​](#java-support-in-semgrep-supply-chain "Direct link to Java support in Semgrep Supply Chain")
...
<Check>
  Java projects can be scanned **without** the need for lockfiles. See [Scan a project without lockfiles (beta)](/docs/semgrep-supply-chain/getting-started#scan-a-project-without-lockfiles-beta).
</Check>

## Java support in Semgrep CE[​](#java-support-in-semgrep-ce "Direct link to Java support in Semgrep CE")
...
[Edit this page](https://github.com/semgrep/semgrep-docs/edit/main/docs/languages/java.md)
