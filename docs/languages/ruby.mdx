...
## Ruby support in Semgrep Supply Chain[​](#ruby-support-in-semgrep-supply-chain "Direct link to Ruby support in Semgrep Supply Chain")
...
## Ruby support in Semgrep CE[​](#ruby-support-in-semgrep-ce "Direct link to Ruby support in Semgrep CE")
...
[Edit this page](https://github.com/semgrep/semgrep-docs/edit/main/docs/languages/ruby.md)
