...
## C# support in Semgrep Supply Chain[​](#c-support-in-semgrep-supply-chain "Direct link to C# support in Semgrep Supply Chain")
...
<Check>
  C# projects can be scanned **without** the need for lockfiles. See [Scan a project without lockfiles (beta)](/docs/semgrep-supply-chain/getting-started#scan-a-project-without-lockfiles-beta).
</Check>

## C# support in Semgrep CE[​](#c-support-in-semgrep-ce "Direct link to C# support in Semgrep CE")
...
[Edit this page](https://github.com/semgrep/semgrep-docs/edit/main/docs/languages/csharp.md)
