...
## Go support in Semgrep Supply Chain[​](#go-support-in-semgrep-supply-chain "Direct link to Go support in Semgrep Supply Chain")
...
## Go support in Semgrep CE[​](#go-support-in-semgrep-ce "Direct link to Go support in Semgrep CE")
...
[Edit this page](https://github.com/semgrep/semgrep-docs/edit/main/docs/languages/go.md)
