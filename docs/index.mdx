...
title: "Semgrep Docs"
sidebarTitle: "Home"
description: "Find bugs and reachable dependency vulnerabilities in code. Enforce your code standards on every commit."
mode: custom
---
...
<p className='text-xl text-[#24434f] dark:text-white'>Deploy static application security testing (SAST), software composition analysis (SCA), and secrets scans from a unified platform.</p>
</div>
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="/quickstart"
  >
    Triage findings and refine your guardrails
  </Card>
  <Card
    title="Write rules"
    icon="pen"
...
<p className='text-l text-[#24434f] dark:text-white'>See the <a href="/getting-started/supported-languages" style={{ color: '#624def', textDecoration: 'none', fontWeight: '500' }} onMouseOver={(e) => e.target.style.textDecoration = 'underline'} onMouseOut={(e) => e.target.style.textDecoration = 'none'}>Supported languages documentation</a> for more details.</p>
</div>

<div className='flex flex-col gap-2 mb-6 mt-10 justify-center items-left'>
<h2 className='text-3xl font-bold text-[#24434f] dark:text-white'>Latest release notes</h2>
<ContentList
  filter={{ tags: ['release-notes'] }}
