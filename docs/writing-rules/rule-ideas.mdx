...
![A reviewer writes a Semgrep rule and adds it to an organization-wide policy](/images/docs/writing-rules/docs/assets/images/semgrep-ci-4c94be66f30fef156679254592d3e2b1.gif)
...
[Ban dangerous APIs with Semgrep](https://semgrep.dev/embed/editor?snippet=zEXn)

## Exempt special cases of dangerous APIs[​](#exempt-special-cases-of-dangerous-apis "Direct link to Exempt special cases of dangerous APIs")
...
[Exempt special cases of dangerous APIs with Semgrep](https://semgrep.dev/embed/editor?snippet=2B3r)
...
[ExpressJS dataflow to sandbox.run](https://semgrep.dev/embed/editor?snippet=jEGP)
...
[Detect security violations in code with Semgrep](https://semgrep.dev/embed/editor?snippet=9Yjy)
...
[Match configuration files with Semgrep](https://semgrep.dev/embed/editor?snippet=rEqJ)
...
[Match Dockerfiles with Semgrep](https://semgrep.dev/embed/editor?snippet=NGXN)
...
[Enforce authentication patterns in code with Semgrep](https://semgrep.dev/embed/editor?snippet=wEQd)
...
[Systematize project-specific coding patterns with Semgrep](https://semgrep.dev/embed/editor?snippet=Nr3z)
...
## Detect deprecated APIs[​](#detect-deprecated-apis "Direct link to Detect deprecated APIs")
...
[Burn down deprecated APIs with Semgrep](https://semgrep.dev/embed/editor?snippet=vEQ0)
...
[Promote secure alternatives with Semgrep](https://semgrep.dev/embed/editor?snippet=ZoA4)
...
[Edit this page](https://github.com/semgrep/semgrep-docs/edit/main/docs/writing-rules/rule-ideas.md)
