...
[Semgrep example Python is comparison](https://semgrep.dev/embed/editor?snippet=Ppde)
...
[Edit this page](https://github.com/semgrep/semgrep-docs/edit/main/docs/writing-rules/overview.md)
