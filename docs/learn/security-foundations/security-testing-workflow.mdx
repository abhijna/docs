...
## Keeping developers in their workflows[​](#keeping-developers-in-their-workflows "Direct link to Keeping developers in their workflows")
...
## Security tools and their features[​](#security-tools-and-their-features "Direct link to Security tools and their features")
...
## Integration into developer workflows[​](#integration-into-developer-workflows "Direct link to Integration into developer workflows")

![Testing Diagram](/images/docs/learn/security-foundations/docs/assets/images/workflow-2f8b67b8e36192523d64d2b7cc72d4cd.png)
...
### Reporting and tracking[​](#reporting-and-tracking "Direct link to Reporting and tracking")
...
[Edit this page](https://github.com/semgrep/semgrep-docs/edit/main/docs/learn/security-foundations/security-testing-workflow.md)
