...
## What is supply chain security?[​](#what-is-supply-chain-security "Direct link to What is supply chain security?")
...
## Why supply chain vulnerabilities matter[​](#why-supply-chain-vulnerabilities-matter "Direct link to Why supply chain vulnerabilities matter")
...
### What is reachability?[​](#what-is-reachability "Direct link to What is reachability?")
...
![SAST and SCA](/images/docs/learn/security-foundations/docs/assets/images/sca-c66eab406c422df21626053404a44b3c.png)
...
## Real-world risks in the software supply chain[​](#real-world-risks-in-the-software-supply-chain "Direct link to Real-world risks in the software supply chain")

Let’s look at some of the ways supply chain vulnerabilities show up in practice.

### Known vulnerabilities in dependencies[​](#known-vulnerabilities-in-dependencies "Direct link to Known vulnerabilities in dependencies")

These are the classic CVE-style issues. An old version of a library has a known bug—like a [command injection](/docs/learn/vulnerabilities/command-injection) or path traversal—and your application still uses that version. This is surprisingly common, and usually easy to fix once identified.

### Dependency confusion[​](#dependency-confusion "Direct link to Dependency confusion")
...
### Typosquatting and malicious packages[​](#typosquatting-and-malicious-packages "Direct link to Typosquatting and malicious packages")
...
### Insecure registries and build systems[​](#insecure-registries-and-build-systems "Direct link to Insecure registries and build systems")
...
* RubyGems for Ruby
* Packagist for PHP
* and [many more](/docs/semgrep-supply-chain/sca-package-manager-support)

## Detect and prioritize supply chain issues[​](#detect-and-prioritize-supply-chain-issues "Direct link to Detect and prioritize supply chain issues")
...
## Best practices for securing your software supply chain[​](#best-practices-for-securing-your-software-supply-chain "Direct link to Best practices for securing your software supply chain")

Securing your supply chain doesn’t mean giving up on open source. It means managing it responsibly.

### Use lockfiles and keep them under version control[​](#use-lockfiles-and-keep-them-under-version-control "Direct link to Use lockfiles and keep them under version control")
...
### Keep dependencies up to date[​](#keep-dependencies-up-to-date "Direct link to Keep dependencies up to date")
...
### Use a reachability-aware SCA tool[​](#use-a-reachability-aware-sca-tool "Direct link to Use a reachability-aware SCA tool")
...
### Audit your dependency graph for unknown or untrusted code[​](#audit-your-dependency-graph-for-unknown-or-untrusted-code "Direct link to Audit your dependency graph for unknown or untrusted code")
...
### Establish a patch and response process[​](#establish-a-patch-and-response-process "Direct link to Establish a patch and response process")
...
[Edit this page](https://github.com/semgrep/semgrep-docs/edit/main/docs/learn/security-foundations/supply-chain-security.md)
