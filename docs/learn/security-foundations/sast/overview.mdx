...
## Source code analysis & taint tracking[​](#source-code-analysis--taint-tracking "Direct link to Source code analysis & taint tracking")
...
![dataflow example](/images/docs/learn/security-foundations/sast/docs/assets/images/sast-dataflow-b2405db9f118fb42f013868d7b98b0e2.png)
...
## Broad language support[​](#broad-language-support "Direct link to Broad language support")
...
## Incorporating security testing into your workflow[​](#incorporating-security-testing-into-your-workflow "Direct link to Incorporating security testing into your workflow")
...
For a comprehensive guide on how to effectively incorporate security testing throughout your development lifecycle, check out our detailed article on [Incorporating security testing into developer workflows](/docs/learn/security-foundations/security-testing-workflow).
...
## Fix guidance[​](#fix-guidance "Direct link to Fix guidance")
...
[Edit this page](https://github.com/semgrep/semgrep-docs/edit/main/docs/learn/security-foundations/sast/overview.md)
