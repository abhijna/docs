...
## What is Command Injection?[​](#what-is-command-injection "Direct link to What is Command Injection?")
...
## Detecting Command Injection Vulnerabilities in Your Code[​](#detecting-command-injection-vulnerabilities-in-your-code "Direct link to Detecting Command Injection Vulnerabilities in Your Code")

To illustrate, here is a simplified Python Flask code example:

```
from flask import Flask, requestimport osapp = Flask(__name__)@app.route("/run")def run_command():    directory = request.args.get("directory")    return_code = os.system("ls " + directory)     return "{'return_code':" + return_code + "}"
```
...
[Edit this page](https://github.com/semgrep/semgrep-docs/edit/main/docs/learn/vulnerabilities/command-injection/overview.md)
