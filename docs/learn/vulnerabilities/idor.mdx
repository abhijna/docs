...
## What Is Insecure Direct Object Reference (IDOR)?[​](#what-is-insecure-direct-object-reference-idor "Direct link to What Is Insecure Direct Object Reference (IDOR)?")
...
## Common Attacks to Exploit IDOR[​](#common-attacks-to-exploit-idor "Direct link to Common Attacks to Exploit IDOR")
...
## Detecting IDOR Vulnerabilities[​](#detecting-idor-vulnerabilities "Direct link to Detecting IDOR Vulnerabilities")
...
```
def get_user_profile(request):    user_id = request.GET.get("id")    user = db.lookup_user(user_id)    return JsonResponse(user.to_dict())
```
...
## Recommendations and Mitigations for Preventing IDOR[​](#recommendations-and-mitigations-for-preventing-idor "Direct link to Recommendations and Mitigations for Preventing IDOR")
...
### Avoid exposing raw IDs[​](#avoid-exposing-raw-ids "Direct link to Avoid exposing raw IDs")
...
### Centralize access checks[​](#centralize-access-checks "Direct link to Centralize access checks")
...
[Edit this page](https://github.com/semgrep/semgrep-docs/edit/main/docs/learn/vulnerabilities/insecure-direct-object-reference/overview.md)
