...
## What is Cross-Site Scripting (XSS)[​](#what-is-cross-site-scripting-xss "Direct link to What is Cross-Site Scripting (XSS)")
...
## Common XSS Attacks[​](#common-xss-attacks "Direct link to Common XSS Attacks")
...
### Stored Cross-Site Scripting[​](#stored-cross-site-scripting "Direct link to Stored Cross-Site Scripting")
...
### Reflected Cross-Site Scripting[​](#reflected-cross-site-scripting "Direct link to Reflected Cross-Site Scripting")
...
### DOM-based Cross-Site Scripting[​](#dom-based-cross-site-scripting "Direct link to DOM-based Cross-Site Scripting")
...
## Detecting XSS Vulnerabilities in Your Code[​](#detecting-xss-vulnerabilities-in-your-code "Direct link to Detecting XSS Vulnerabilities in Your Code")
...
```
<form action="/search">  <input type="text" name="q"></form><p>You searched for: <span id="result"></span></p><script>  const params = new URLSearchParams(window.location.search);  document.getElementById('result').innerHTML = params.get('q');</script>
```
...
[Edit this page](https://github.com/semgrep/semgrep-docs/edit/main/docs/learn/vulnerabilities/cross-site-scripting/overview.md)
