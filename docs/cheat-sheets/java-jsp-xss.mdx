...
## 1. Server code: writing a response directly[​](#1-server-code-writing-a-response-directly "Direct link to 1. Server code: writing a response directly")

### 1.A Using the **PrintWriter** from **HttpServletResponse**[​](#1a-using-the-printwriter-from-httpservletresponse "Direct link to 1a-using-the-printwriter-from-httpservletresponse")
...
[java.lang.security.audit.xss.no-direct-response-writer.no-direct-response-writer](https://semgrep.dev/r?q=java.lang.security.audit.xss.no-direct-response-writer.no-direct-response-writer)

### 1.B. Using the **OutputStream** from **HttpServletResponse**[​](#1b-using-the-outputstream-from-httpservletresponse "Direct link to 1b-using-the-outputstream-from-httpservletresponse")
...
## 2. JSP page: Variable is not explicitly escaped[​](#2-jsp-page-variable-is-not-explicitly-escaped "Direct link to 2. JSP page: Variable is not explicitly escaped")

### 2.A. Any variable used without **\<c:out ...>** tag[​](#2a-any-variable-used-without-c--tag "Direct link to 2a-any-variable-used-without-c--tag")
...
[java.lang.security.audit.xss.jsp.use-escapexml.use-escapexml](https://semgrep.dev/r?q=java.lang.security.audit.xss.jsp.use-escapexml.use-escapexml)

### 2.B.Any expression without **escapeXml**[​](#2bany-expression-without-escapexml "Direct link to 2bany-expression-without-escapexml")
...
## 3. JSP page: Variable in dangerous location[​](#3-jsp-page-variable-in-dangerous-location "Direct link to 3. JSP page: Variable in dangerous location")

### 3.A. Unquoted variable in HTML attribute[​](#3a-unquoted-variable-in-html-attribute "Direct link to 3.A. Unquoted variable in HTML attribute")
...
### 3.B. Variable in **href** attribute[​](#3b-variable-in-href-attribute "Direct link to 3b-variable-in-href-attribute")
...
### 3.C. Variable in **\<script>** block[​](#3c-variable-in-script-block "Direct link to 3c-variable-in-script-block")
...
[Edit this page](https://github.com/semgrep/semgrep-docs/edit/main/docs/cheat-sheets/java-jsp-xss.mdx)
