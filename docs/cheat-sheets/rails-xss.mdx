...
## 1. Unescaped variable enters template engine in Ruby code[​](#1-unescaped-variable-enters-template-engine-in-ruby-code "Direct link to 1. Unescaped variable enters template engine in Ruby code")

### 1.A. Using **html\_safe()**[​](#1a-using-html_safe "Direct link to 1a-using-html_safe")
...
[ruby.rails.security.audit.xss.avoid-html-safe.avoid-html-safe](https://semgrep.dev/r?q=ruby.rails.security.audit.xss.avoid-html-safe.avoid-html-safe)

### 1.B. Using **content\_tag()**[​](#1b-using-content_tag "Direct link to 1b-using-content_tag")
...
[ruby.rails.security.audit.xss.avoid-content-tag.avoid-content-tag](https://semgrep.dev/r?q=ruby.rails.security.audit.xss.avoid-content-tag.avoid-content-tag)

### 1.C. Using **raw()**[​](#1c-using-raw "Direct link to 1c-using-raw")
...
[ruby.rails.security.audit.xss.avoid-raw.avoid-raw](https://semgrep.dev/r?q=ruby.rails.security.audit.xss.avoid-raw.avoid-raw)

### 1.D. Disabling of **ActiveSupport#escape\_html\_entities\_in\_json**[​](#1d-disabling-of-activesupportescape_html_entities_in_json "Direct link to 1d-disabling-of-activesupportescape_html_entities_in_json")
...
[ruby.lang.security.json-entity-escape.json-entity-escape](https://semgrep.dev/r?q=ruby.lang.security.json-entity-escape.json-entity-escape)

***

## 2. Bypassing the template engine[​](#2-bypassing-the-template-engine "Direct link to 2. Bypassing the template engine")

### 2.A. Manually creating an ERB template[​](#2a-manually-creating-an-erb-template "Direct link to 2.A. Manually creating an ERB template")
...
[ruby.rails.security.audit.xss.manual-template-creation.manual-template-creation](https://semgrep.dev/r?q=ruby.rails.security.audit.xss.manual-template-creation.manual-template-creation)

### 2.B. Rendering an inline template with **render inline**[​](#2b-rendering-an-inline-template-with-render-inline "Direct link to 2b-rendering-an-inline-template-with-render-inline")
...
[ruby.rails.security.audit.xss.avoid-render-inline.avoid-render-inline](https://semgrep.dev/r?q=ruby.rails.security.audit.xss.avoid-render-inline.avoid-render-inline)

### 2.C. Using **render text:**[​](#2c-using-render-text "Direct link to 2c-using-render-text")
...
[ruby.rails.security.audit.xss.avoid-render-text.avoid-render-text](https://semgrep.dev/r?q=ruby.rails.security.audit.xss.avoid-render-text.avoid-render-text)
...
### 3.A. Using **html\_safe()**[​](#3a-using-html_safe "Direct link to 3a-using-html_safe")
...
[ruby.rails.security.audit.xss.templates.avoid-html-safe.avoid-html-safe](https://semgrep.dev/r?q=ruby.rails.security.audit.xss.templates.avoid-html-safe.avoid-html-safe)

### 3.B Using **content\_tag()**[​](#3b-using-content_tag "Direct link to 3b-using-content_tag")
...
[ruby.rails.security.audit.xss.templates.avoid-content-tag.avoid-content-tag](https://semgrep.dev/r?q=ruby.rails.security.audit.xss.templates.avoid-content-tag.avoid-content-tag)

### 3.C. Using **raw()**[​](#3c-using-raw "Direct link to 3c-using-raw")
...
[ruby.rails.security.audit.xss.templates.avoid-raw.avoid-raw](https://semgrep.dev/r?q=ruby.rails.security.audit.xss.templates.avoid-raw.avoid-raw)

### 3.D. Using **\<%== ... %>**, which is an alias for **html\_safe()**[​](#3d-using----which-is-an-alias-for-html_safe "Direct link to 3d-using----which-is-an-alias-for-html_safe")
...
[ruby.rails.security.audit.xss.templates.alias-for-html-safe.alias-for-html-safe](https://semgrep.dev/r?q=ruby.rails.security.audit.xss.templates.alias-for-html-safe.alias-for-html-safe)
...
[ruby.rails.security.audit.xss.templates.unquoted-attribute.unquoted-attribute](https://semgrep.dev/r?q=ruby.rails.security.audit.xss.templates.unquoted-attribute.unquoted-attribute)
...
[ruby.rails.security.audit.xss.templates.var-in-href.var-in-href](https://semgrep.dev/r?q=ruby.rails.security.audit.xss.templates.var-in-href.var-in-href)

### 4.C. Using **link\_to** with unrestricted URL scheme[​](#4c-using-link_to-with-unrestricted-url-scheme "Direct link to 4c-using-link_to-with-unrestricted-url-scheme")
...
* [Brakeman scanner - link\_to](https://github.com/presidentbeef/brakeman/blob/main/docs/warning_types/link_to_href/index.markdown)
...
[ruby.rails.security.audit.xss.templates.dangerous-link-to.dangerous-link-to](https://semgrep.dev/r?q=ruby.rails.security.audit.xss.templates.dangerous-link-to.dangerous-link-to)

### 4.D. Variable in **\<script>** block[​](#4d-variable-in-script-block "Direct link to 4d-variable-in-script-block")
...
[ruby.rails.security.audit.xss.templates.var-in-script-tag.var-in-script-tag](https://semgrep.dev/r?q=ruby.rails.security.audit.xss.templates.var-in-script-tag.var-in-script-tag)
...
[Edit this page](https://github.com/semgrep/semgrep-docs/edit/main/docs/cheat-sheets/rails-xss.mdx)
